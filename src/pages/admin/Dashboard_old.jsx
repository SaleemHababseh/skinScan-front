...
import { Users, FileText, BarChart2, Activity, Settings, AlertTriangle, UserCheck, UserX } from 'lucide-react';
...
const AdminDashboard = () => {
  ...
  const loadAdminData = async () => {
    ...
    try {
      ...
      setRecentActivities([
        { id: 1, type: 'user_registration', message: `${Array.isArray(patients) ? patients.length : 0} patients registered`, time: 'Today' },
        ...
        { id: 3, type: 'diagnosis_completed', message: `${Array.isArray(allRecords) ? allRecords.length : 0} total diagnoses`, time: 'All time' }
      ]);
