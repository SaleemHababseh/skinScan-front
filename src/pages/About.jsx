  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-8 text-primary-500">About MedConnect</h1>
        
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          <h2 className="text-2xl font-semibold mb-4">Our Mission</h2>
          <p className="text-gray-700 mb-4">
            MedConnect is dedicated to bridging the gap between patients and healthcare providers through innovative technology.
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          ...
          <p className="text-gray-700 mb-4">
            Founded in 2023, MedConnect emerged from a simple observation: healthcare systems worldwide face challenges in coordination,
